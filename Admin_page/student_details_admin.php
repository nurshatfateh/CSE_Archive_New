              ...
              <div class="card-body bg-white ">
                <a
                  ...
                  <div class="p-3  border border-2  border-info">
                    <h6 class="text-decoration-none text-black"><img class="ms-3" src="../img/studen2.jpg" style="width:50px;height:60px;"  alt="profile"/> &nbsp;&nbsp;201914055      :     Saheenur Islam Sumon   (BME-02)
