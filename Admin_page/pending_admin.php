        ...
        <div class="row gx-5">
          ...
          <div class="col-xxl-9 col-12">
            ...
            <div class="card mb-5 border border-3  border-info">
                <h5 class="card-header text-white bg-info ">Faculty Request</h5>
                
                      <div class="card-body bg-white ">
                          <a
                          href="facultyprofile_pending_admin.html"
                          ...
                          <div class="p-3  border border-2  border-info">
                              ...
                              <a href="pending_admin.html" class="text-decoration-none">
                     ...
                     ><div class="p-3 mt-2 mb-2 border border-2  border-info">
                       ...
                       <div class=" text-black">
                         <p class="m-0 p-2">
                           ...
                           | 2019-2020
                           <a href="pending_admin.html" class="text-decoration-none float-end">
                             <div class="btn-group float-end" role="group" aria-label="Basic example">
                               <button type="button" class="btn btn-outline-success">Accept</button>
                               <button type="button" class="btn btn-outline-danger">Reject</button>
                             </div>
            ...
            <div class="card mb-5 border border-3  border-info">
                <h5 class="card-header text-white bg-info ">Pending Thesis</h5>
                <div class="card-body bg-white">
                    <a
                     href="thesis_details_pending_admin.html"
                     class="text-decoration-none text-black"
                     ><div class="p-3 mt-2 mb-2 border border-2  border-info">
