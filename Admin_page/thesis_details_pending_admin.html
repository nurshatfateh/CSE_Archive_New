      ...
      <div class="container-fluid">
        ...
        >
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item mx-3 ">
              <a class="nav-link active text-success fw-bolder" href="thesis_admin.html">Thesis</a>
            </li>
            <li class="nav-item mx-3">
            ...
            <div class="card mb-5 border-0 ">
                ...
                <form>
                  <div class="form-group">
                    <textarea class="form-control border-3" id="faculty_select" rows="7" placeholder="Comment"></textarea>
                  </div>
                </form>
              
              </div>
              <a href="thesis_list_admin.html" class="text-decoration-none"> 
              <div class="card mb-5 border-0 ">
