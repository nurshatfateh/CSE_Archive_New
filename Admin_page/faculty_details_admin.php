...
<html lang="en">
  <head>
    ...
    <title>Faculty_details_admin</title>
  </head>
  <body>
    <!-- navbar starts -->
...
<div class="card-body bg-white ">
                <a
                  ...
                  <h6 class="text-decoration-none text-black"><img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" style="width:50px;height:50px;border-radius: 50%;"/>&nbsp;&nbsp;<?php echo $row["name"]."      :          ".$row["dept"]; 
