      ...
      <div class="container pt-5">
        <div class="card-body bg-white">
          <div class="p-3 mt-2 mb-2 border border-3 border-info">
            ...
            <img <?php echo "src='images/" . $row['AchievementPhoto'] . "' "; ?> class="rounded my-3 mx-auto d-block" style="width: 80%" alt="..." />
          ...
          <div class="col-md-8 col-12 p-4 pt-4 main-content">
            ...
            <div class="container ps-2 pe-2">
              <div class="row">
                ...
                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, student S where id=$code AND A.Member1ID=S.roll");
                ...
                ?>
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />


                    <h5 class="mt-3 text-center"><?php echo $row1["name"]; ?></h5>
                ...
                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, student S where id=$code AND A.Member2ID=S.roll");
                $row1 = mysqli_fetch_array($result1);
                if (mysqli_num_rows($result1) > 0) {
                ?>
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    ...
                    <h5 class="mt-3 text-center"><?php echo $row1["name"]; ?></h5>
                    <p class="m-0 text-center"><?php echo $row1["Member2ID"]; ?></p>

                  </div>
                <?php }; ?>

                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, student S where id=$code AND A.Member3ID=S.roll");
                $row1 = mysqli_fetch_array($result1);
                if (mysqli_num_rows($result1) > 0) {
                ?>
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />
                    <h5 class="mt-3 text-center"><?php echo $row1["name"]; ?></h5>
                    <p class="m-0 text-center"><?php echo $row1["Member3ID"]; ?></p>
                  </div>
                <?php }; ?>

                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, student S where id=$code AND A.Member4ID=S.roll");
                $row1 = mysqli_fetch_array($result1);
                if (mysqli_num_rows($result1) > 0) {
                ?>
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />
                    <h5 class="mt-3 text-center"><?php echo $row1["name"]; ?></h5>
                    <p class="m-0 text-center"><?php echo $row1["Member4ID"]; ?></p>
                  </div>
                <?php }; ?>

                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, student S where id=$code AND A.Member5ID=S.roll");
                $row1 = mysqli_fetch_array($result1);
                if (mysqli_num_rows($result1) > 0) {
                ?>
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />
                    <h5 class="mt-3 text-center"><?php echo $row1["name"]; ?></h5>
                    <p class="m-0 text-center"><?php echo $row1["Member5ID"]; ?></p>
            ...
            <div class="container ps-2 pe-2">
              <div class="row">
                ...
                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, faculty f where A.id=$code AND A.Supervisor1=f.name");
                $row1 = mysqli_fetch_array($result1);
                if (mysqli_num_rows($result1) > 0) {
                ?>
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />
                    <h5 class="mt-3 text-center"><?php echo $row1["Supervisor1"]; ?></h5>
                  </div>
                <?php }; ?>


                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, faculty f where A.id=$code AND A.Supervisor2=f.name");
                ...
                ?>
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />
                    <h5 class="mt-3 text-center"><?php echo $row1["Supervisor2"]; ?></h5>
                  </div>
                <?php }; ?>


                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, faculty f where A.id=$code AND A.Supervisor3=f.name");
                ...
                ?>
                  ...
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />
                    <h5 class="mt-3 text-center"><?php echo $row1["Supervisor3"]; ?></h5>
                  </div>
                <?php }; ?>


                <?php
                $result1 = mysqli_query($conn, "SELECT * FROM addachievement A, faculty f where A.id=$code AND A.Supervisor4=f.name");
                ...
                ?>
                  ...
                  <div class="col-md-3 col-6 py-4 border border-info border-2 m-3 rounded">
                    <img style="width: 60%" class="mx-auto d-block" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row1['image']); ?>" alt="" />
                    <h5 class="mt-3 text-center"><?php echo $row1["Supervisor4"]; ?></h5>
                  </div>
                <?php }; ?>
              </div>
            </div>
