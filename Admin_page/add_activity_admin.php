  ...
  <body class="bg-light">
    ...
    <div class="bg-light">
      <div class="container mt-5" style="padding:0px 10px 0px 0px">
        <h2 style="text-align: left"><b>Add Activity :</b></h2>
      </div>

      <div class="container mt-5">

        <form class="row g-3 bg-white border p-3 border-1" style="border-radius: 5px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" action="Con_addActivity.php" method="post" enctype="multipart/form-data">
          <!-- <form class="row g-3 bg-white border p-3" method="post" enctype="multipart/form-data"> -->
          <div class="col-md-6">
            <label for="EventName" class="form-label">
              <h6>Event Name <font color="ff0000">*</font>
              </h6>
            </label>
            <input type="text" required class="form-control" id="EventName" name="EventName" placeholder="Event Name" />
          </div>

          <div class="col-md-6">
            <label for="EventTag" class="form-label">
              <h6>Post Tag Line<font color="ff0000">*</font>
              </h6>
            </label>
            <input type="text" required class="form-control" id="EventTag" name="EventTag" placeholder="Event Tag" />
          </div>
          ...
          <div class="col-md-12">
            ...
            <textarea class="form-control" id="PostDetails" name="PostDetails" rows="3" required></textarea>
          </div>
          ...
          <div class="col-md-6">
            <label for="Main Photo" class="form-label">
              <h6>Main Photo(jpg/png/jpeg)<font color="ff0000"></font>
              </h6>
            </label>
            <br />
            <input type="File" accept="image/*" id="ActivityPic" name="ActivityPic" />
          </div>
