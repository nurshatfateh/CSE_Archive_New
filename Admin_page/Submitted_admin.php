...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-light">
      ...
      <div class="container pt-5">
        <div class="mx-auto">
          <img
            ...
            src="https://cms.jotform.com/uploads/image_upload/image_upload/Jan/40194_tytytyty.png"
            class="card-img-top"
            alt="..."
          />

          <a href="home_admin.php"
            ><button type="button" class="btn btn-primary d-block mx-auto my-3">
              Go Home
            </button></a
          >
        </div>
      ...
      <div class="container-fluid bg-black py-2 mt-2">
        <div class="row">
