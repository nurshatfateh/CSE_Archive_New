      ...
      <div class="container pt-5">
        <div class="card">
          <div class="card-body bg-primary p-4">
            ...
            <a href="add_activity_admin.php"><button type="button" class="btn btn-light btn-lg float-end">
                + Add ACTIVITIES
              </button></a>
          </div>
        </div>
        ...
        <div class="row bg-light border border-3">
          <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
              ...
              $result = mysqli_query($conn, "SELECT * FROM addactivity order by CompletionDate desc LIMIT 5");
              ?>
              <?php
      ...
      <div class="container px-4 pt-5">
        ...
        <div class="col-xxl-9 col-12">
          ...
          <div class="row bg-light border border-3 border border-info gx-4">
            ...
            $sql = 'SELECT * FROM addactivity  order by CompletionDate desc LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
                ...
                <div class="col-sm-4 mb-5 mt-5">
                  <div class="card border-2 border-info ms-3">
                    <div class="card-body">
                      ...
                      <a href="activity_details_admin.php?id=<?php echo $row["id"]; ?>"><img <?php echo "src='images/" . $row['ActivityPhoto'] . "' "; ?> class="d-block my-3 mx-auto" style="width: 100%; height: 200px" alt="..." /></a>
