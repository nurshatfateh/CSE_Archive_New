...
<html lang="en">
  ...
  <div class="container">
    ...
    <h3 class="my-5">ADD Student info by uploading CSV file:</h3>
  ...
  <div class="container">
    ...
    <h3 class="my-5">ADD Faculty info by uploading CSV file:</h3>
      <div class="input-group">
        <div class="custom-file">
          <input type="file" class="custom-file-input" id="customFileInput" aria-describedby="customFileInput" name="file">
          <label class="custom-file-label" for="customFileInput">Select file</label>
      ...
      <div class="container-fluid bg-black py-2 mt-5" style="
  position: absolute;
  right: 0;
  bottom: 0;
  left: 0;
