      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse mx-5 fw-bold" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item mx-3">
              <a class="nav-link active text-success fw-bolder" aria-current="page" href="activity_admin.php">Activity</a>
            </li>
          </ul>
      ...
      <div class="container pt-5">
        <div class="card-body bg-white">
          <div class="p-3 mt-2 mb-2 border border-3 border-info">
            ...
            <img <?php echo "src='images/" . $row['ActivityPhoto'] . "' "; ?> class="rounded my-3 mx-auto d-block" style="width: 80%" alt="..." />
            <h3 class="mb-2 mt-3 text-center"><?php echo $row["EventTag"]; ?></h3><br><br>
            <h5 class="text-center">Starting Date :
              <?php echo date('d-M-y', strtotime($row["CommenceDate"])) ?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
              <!-- </p> -->
              Ending Date :
              <?php echo date('d-M-y', strtotime($row["CompletionDate"])) ?>
            </h5>
        ...
        <div class="row border bg-white m-0">
          ...
          <div class="col-12 p-4 pt-4 main-content">
            ...
            <div class="container ps-2 pe-2">
              <div class="row">
                <div class="col-md-3 col-6 py-4 border border-info border-2 m-2 rounded">
                  <img style="width: 80%" class="mx-auto my-auto d-block mt-5" src="../img/act5.jpg" alt="" />
                </div>

                <div class="col-md-3 col-6 py-4 border border-info border-2 m-2 rounded">
                  <img style="width: 80%" class="mx-auto my-auto d-block mt-5" src="../img/act2.jpg" alt="" />
                </div>

                <div class="col-md-3 col-6 py-4 border border-info border-2 m-2 rounded">
                  <img style="width: 80%" class="mx-auto my-auto d-block mt-5" src="../img/act3.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
